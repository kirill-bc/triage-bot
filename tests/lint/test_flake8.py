...
def test_flake8_passes_on_src_and_tests() -> None:
    ...
    result = subprocess.run(
        [
            ...
            str(root / "src" / "triage_service" / "adapters" / "automation_webhook_executor.py"),
            str(root / "src" / "triage_service" / "adapters" / "jira_issue_fetcher.py"),
            str(root / "src" / "triage_service" / "adapters" / "zendesk_ticket_fetcher.py"),
            str(root / "src" / "triage_service" / "adapters" / "zendesk_oauth.py"),
            ...
            str(root / "webhook_triage_cli.py"),
